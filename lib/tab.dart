...
class VerticalTabs extends StatefulWidget {
  ...
  VerticalTabs(
      ...
      this.selectedTabBackgroundColor = Colors.white70,
      this.tabBackgroundColor = Colors.white,
      this.selectedTabTextStyle = const TextStyle(color: Colors.white),
      this.tabTextStyle = const TextStyle(color: Colors.black38),
      this.changePageCurve = Curves.easeInOut,
      this.changePageDuration = const Duration(milliseconds: 300),
      this.tabsShadowColor = Colors.white,
                ...
                children: <Widget>[
                  Material(
                    child: Container(
                      ...
                      constraints: BoxConstraints(maxWidth: 300, minWidth: 195),
