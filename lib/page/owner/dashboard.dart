...
import 'package:aplikasi_arisan/page/blocs/owner/owner_bloc.dart';
...
import 'package:aplikasi_arisan/resources/owner_api.dart';
...
class _DashboardOwnerState extends State<DashboardOwner> {
  ...
  final OwnerBloc _ownerBloc = OwnerBloc();
  ...
  final ownerApiProvider = OwnerApiProvider();
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () async {
                        Map<String, dynamic> jwt =
                            await ownerApiProvider.attemptLogOut();
                        if (jwt['status_code'] == 200) {
                          storage.delete(key: "jwt");
                          storage.delete(key: "jwtOwner");
  ...
  Widget _buildAkun(BuildContext context, OwnerModel model) {
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(15),
