...
class _FotoMenangState extends State<FotoMenang> {
  ...
  Widget build(BuildContext context) {
    var a = MediaQuery.of(context).size.width * 0.082;
    return (widget.statusarisan.buktiTransferMenang != null)
        ? GestureDetector(
            onTap: () async {
              ...
              showDialog(
                ...
                builder: (context) => AlertDialog(
                  ...
                  title: Center(
                    child: Text(
                        "Bukti Menang User : " +
                            widget.statusarisan.statuskepemilikan.username,
                        ...
                        child: Image(
                          ...
                          image: NetworkImage(
                              'https://api.moneykingdom.org/public/bukti-transfer-menang/' +
                                  widget.statusarisan.buktiTransferMenang,
                              scale: 1.0),
                        ),
                      ),
                    ),
