...
class BuktiMenang extends StatefulWidget {
  final Peserta peserta;
  BuktiMenang(this.peserta);

  @override
  _BuktiMenangState createState() => _BuktiMenangState();
}

class _BuktiMenangState extends State<BuktiMenang> {
          ...
          children: <Widget>[
            ...
            FlatButton(
              ...
              onPressed: () async {
                ...
                var id = widget.peserta.id.toString();

                File bukti = _fotoBuktiMenang;
                Map<String, dynamic> jwt =
                    await adApiProvider.uploadBuktiMenang(id, bukti);
                print(jwt);
